...
class XueqiuChannel(Channel):
    ...
    def check(self, config=None):
        ...
        try:
            ...
            return "warn", "API response is abnormal (returned data is empty)"
            ...
            return "warn", (
                ...
                "For a login cookie, run: agent-reach configure "
    ...
    def get_stock_quote(self, symbol: str) -> dict:
        ...
        Args:
            symbol: ticker, for example SH600519 (Shanghai), SZ000858 (Shenzhen), AAPL (US), 00700 (Hong Kong)
    ...
    def search_stock(self, query: str, limit: int = 10) -> list:
        ...
        Args:
            query: ticker or Chinese name, for example "Moutai" or "600519"
    ...
    def get_hot_stocks(self, limit: int = 10, stock_type: int = 10) -> list:
        """Fetch the hot-stock ranking.

        Args:
            limit:      maximum number of results (capped at 50)
            stock_type: 10 = popularity board (default), 12 = follow board
